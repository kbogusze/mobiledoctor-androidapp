...
public class Doctor_Menu_Activity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctor= Login_Activity.getDoctor();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if (id == R.id.nav_polingdesign) {
            Intent startNew_Doctor_PollingDesign_Activity = new Intent(this,Doctor_PollingDesign_Activity.class);
            startActivity(startNew_Doctor_PollingDesign_Activity);
        }
        else if (id == R.id.nav_pacientlist) {
            Intent startNew_Doctor_PatientList_Activity = new Intent(this,Doctor_PatientList_Activity.class);
            startActivity(startNew_Doctor_PatientList_Activity);
        }
