...
public class Doctor_Register_Activity extends AppCompatActivity {
...
// Reset errors.
        ...
        profesion = String.valueOf(mproffesioniew.getText());
        ...
        // Check for a valid password, if the user entered one.
        if (TextUtils.isEmpty(profesion)) {
            mproffesioniew.setError("Wpisz Specjalizacje");
            focusView = mproffesioniew;
            cancel = true;
        }
        ...
        if (cancel) {
            ...
            if (mpasswordView.getText().toString().equals(mpassword2View.getText().toString())) {
                if (isNetworkAvailable(getApplicationContext())) {
                    ...
                    doctor = new DoctorModel(id, pacientname, email, password, profesion, phonenumber, city, questions, patients);
                    String url = "http://boguinzynierkarestapi.azurewebsites.net/api/status/";
                    new PostDataTask().execute(url);
                } else {

                    new AlertDialog.Builder(Doctor_Register_Activity.this)
                            .setTitle("Błąd")
    ...
    public class PostDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = new ProgressDialog(Doctor_Register_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(Doctor_Register_Activity.this, responsecode, Toast.LENGTH_SHORT).show();
            if(responsecode.equals("Udało się zarejestrować")){
                Intent i = new Intent(Doctor_Register_Activity.this, Login_Activity.class);
