...
public class Doctor_Profile_Activity extends AppCompatActivity {
    ...
    private EditText mproffesioniew;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mproffesioniew = (EditText) findViewById(R.id.ageeditText);
        button = (Button) findViewById(R.id.savebutton);

        //     mnameView.setText(doctor.getDoctorname());
        memailView.setText(doctor.getEmail());
        //     mpasswordView.setText(doctor.getPassword());
        mdirecionView.setText(doctor.getCity());
        mTelNrView.setText(doctor.getPhonenumber());
        mproffesioniew.setText(doctor.getProfesion());
        ...
        if (!password.equals("") || !newpassword.equals("") || !newpassword2.equals("")) {
            ...
            if (!password.equals(doctor.getPassword())) {
                ...
                if (mnewpasswordView.getText().toString().equals(mnewpassword2View.getText().toString()) && cancel == false)
                    doctor.setPassword(String.valueOf(mnewpasswordView.getText()));
            }
        }
        ...
        if (cancel) {
            ...
            if (mnewpasswordView.getText().toString().equals(mnewpassword2View.getText().toString())) {
                if (isNetworkAvailable(getApplicationContext())) {
                    //     doctor.setDoctorname(String.valueOf(mnameView.getText()));
                    doctor.setEmail(String.valueOf(memailView.getText()));
                    //      doctor.setPassword(String.valueOf(mpasswordView.getText()));
                    doctor.setCity(String.valueOf(mdirecionView.getText()));
                    doctor.setPhonenumber(String.valueOf(mTelNrView.getText()));
                    doctor.setProfesion(String.valueOf(mproffesioniew.getText()));
                    ...
                    new AlertDialog.Builder(Doctor_Profile_Activity.this)
                            .setTitle("Błąd")
    ...
    public class PutDataTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(Doctor_Profile_Activity.this);
        ...
        protected void onPostExecute(String result) {
            ...
            Toast.makeText(Doctor_Profile_Activity.this, result.toString(), Toast.LENGTH_SHORT).show();
        ...
        private String putData(String urlPath) throws IOException, JSONException {
            ...
            JSONObject dataToSend = doctor.doctortoJson(doctor);
